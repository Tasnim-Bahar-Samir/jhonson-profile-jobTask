  ...
  return (
    <div>
      ...
      {premiumContents.map((content) => {
       return <div className="card h-[171px] mt-5 card-side border-2 shadow-xl">
          ...
          <div className="text-left ml-6 flex flex-col justify-center">
            ...
            <div className="card-actions mt-6">
              <button className= "action-btn bg-white px-5 py-2 text-gray-700 gap-3 shadow-white hover:shadow-2xl rounded-lg flex items-center"><AiFillHeart/>Subscribe to Unlock</button>
            </div>
          </div>
        </div>;
      })}
...
<div className="card h-[171px] mt-16 card-side border-2 shadow-xl">
          ...
          <div className="text-left w-1/2 flex flex-col items-center justify-center">
            <div className="card-actions mt-6">
              <button className= "action-btn bg-white px-5 py-2 text-gray-700 gap-3 shadow-white hover:shadow-2xl rounded-lg flex items-center"><AiFillHeart/>Buy for $4.99</button>
            </div>
          </div>
        </div>

        <a href="https://www.youtube.com/playlist?list=PLM2ccN457sxRuVSqTHINmtkkwiJq1txwW" target='_blank'  className="py-3 rounded-xl border-2 mt-5 relative block">
